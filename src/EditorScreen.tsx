    ...
    <SafeAreaProvider>
      <SafeAreaView style={styles.container}>
        ...
        <View style={{flex: 1, marginHorizontal: 4, justifyContent: 'center'}}>
          ...
          ? <ChordChart measures={state.measures} onUpdateChord={state.update}/>
        ...
        <View style={{flexDirection: 'row', borderTopWidth: 1, padding: 8, gap: 8}}>
          ...
          <TextButton title='Export' onPress={() => navigation.navigate('Export', {serializedChart: collapseFromMeasures(state.measures, 4)})}/>
          <TextButton title='Import' onPress={() => navigation.navigate('Camera')}/>
        </View>
      </SafeAreaView>
    </SafeAreaProvider>
  );
